...
const presentationLayer = (() => {
    ...
    function createTask(){
        ...
        taskTitleEl.innerText = taskTitle.value;
        const taskDescEl = document.createElement('p'); //task description
        taskDescEl.innerText = taskDescription.value;
        ...
        // deleteBtnWrap.appendChild(deleteTaskIcon);
        ...
        boxCount(); //   For each item added reset the count on each box
